...
V = np.load("/scratch/yjk27/CA1_clust4-60_AP/whole_pred/V_whole_pred.npy").flatten()
...
for i in tnrange(iter_no):
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust4-60_AP/whole_pred/AP_nn_k1_l2_h5_i"+str(i)+".pt")
