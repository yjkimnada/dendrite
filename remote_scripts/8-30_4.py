...
C_syn_e = np.load("/scratch/yjk27/CA1_clust8-30/data/randsub14_C_syn_e.npy")
C_syn_i = np.load("/scratch/yjk27/CA1_clust8-30/data/randsub14_C_syn_i.npy")
...
for i in tnrange(iter_no):
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust8-30_noNA/rand/gru_s14_h20_i"+str(i)+".pt")
