...
cell_type = "CA1"
E_neural_file = "Espikes_neural_set2.npz"
I_neural_file = "Ispikes_neural_set2.npz"
#V_file  = "vdata_T10_Ne2000_gA0.6_tauA1_gN0.8_Ni200_gG0.1_gB0.1_Er0.5_Ir7.4_random_NR_rep1000_stimseed1_set1.npy"
V_file = "vdata_T10_Ne2000_gA0.6_tauA1_gN0.8_Ni200_gG0.1_gB0.1_noDendNa_Er0.5_Ir7.4_random_NR_rep1000_stimseed1_set2.npy"
#V_file = "V_diff_stimseed1.npy"

#E_neural = scipy.sparse.load_npz(base_dir+cell_type+"_"+experiment+"/data/"+E_neural_file)
#I_neural = scipy.sparse.load_npz(base_dir+cell_type+"_"+experiment+"/data/"+I_neural_file)
E_neural = scipy.sparse.load_npz("/scratch/yjk27/CA1_clust4-60/data/Espikes_neural_set2.npz")
I_neural = scipy.sparse.load_npz("/scratch/yjk27/CA1_clust4-60/data/Ispikes_neural_set2.npz")
...
for i in tnrange(iter_no):
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust8-30_noNA/global/glm_s1_h2_i"+str(i)+"_set2.pt")
