...
V = np.load("/scratch/yjk27/CA1_clust4-60_AP/na_pred_nona_true/V_na_pred_nona_true_0.2ms.npy").reshape(-1,batch_length)
...
#for i in tnrange(10000):    
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust4-60_aSoma/na_pred_nona_true/gru_l20_h40_0.2ms_i"+str(i)+".pt")
        np.save("/scratch/yjk27/CA1_clust4-60_aSoma/na_pred_nona_true/gru_l20_h40_0.2ms_test_i"+str(i)+".npy", test_S_out.cpu().detach().numpy())