...
V = np.load("/scratch/yjk27/CA1_clust4-60_AP/na_true_2noise1/V_na_true_2noise1_0.2ms.npy").reshape(-1,batch_length)
...
for i in tnrange(15000):    
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust4-60_AP/na_true_2noise1/gru_l20_h40_0.2ms_i"+str(i)+".pt")
        np.save("/scratch/yjk27/CA1_clust4-60_AP/na_true_2noise1/gru_l20_h40_0.2ms_test_i"+str(i)+".npy", test_S_out.cpu().detach().numpy())