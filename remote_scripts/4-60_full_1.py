...
from models.full_gru import Full_GRU
...
model = Full_GRU(E_no, I_no, H_no, device)
...
for i in tnrange(iter_no):
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust4-60/full/gru_h150_clip_i"+str(i)+".pt")
