...
E_neural = scipy.sparse.load_npz("/scratch/yjk27/CA1_clust4-60/data/Espikes_neural_set3.npz")
I_neural = scipy.sparse.load_npz("/scratch/yjk27/CA1_clust4-60/data/Ispikes_neural_set3.npz")
...
for i in tnrange(iter_no):
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust8-30_noNA/global/glm_s1_h2_i"+str(i)+"_set3.pt")
