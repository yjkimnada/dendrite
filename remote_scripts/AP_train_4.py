...
#for i in tnrange(10000):    
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust4-60_aSoma/nona_true/gru_l20_h40_0.2ms_i"+str(i)+".pt")
        np.save("/scratch/yjk27/CA1_clust4-60_aSoma/nona_true/gru_l20_h40_0.2ms_test_i"+str(i)+".npy", test_S_out.cpu().detach().numpy())