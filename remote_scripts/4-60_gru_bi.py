...
C_syn_e = np.load("/scratch/yjk27/CA1_clust4-60/data/handsub5_C_syn_e.npy")
C_syn_i = np.load("/scratch/yjk27/CA1_clust4-60/data/handsub5_C_syn_i.npy")
...
model = GRU(C_syn_e.to(device), C_syn_i.to(device), H_no, 1, True, device)
...
for i in tnrange(iter_no):
    ...
    if (i%50 == 49) or (i == 0):
        ...
        torch.save(model.state_dict(), "/scratch/yjk27/CA1_clust4-60/hand/gru_bi_s5_h20_i"+str(i)+".pt")
